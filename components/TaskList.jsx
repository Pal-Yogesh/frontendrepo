...
export default function TaskList({ tasks, setTasks, refreshTasks }) {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await fetch("https://backendrepo-wpmj.onrender.com//users", { credentials: "include" });
    ...
    const fetchCurrentUser = async () => {
      try {
        const res = await fetch("https://backendrepo-wpmj.onrender.com//auth/profile", { credentials: "include" });
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://backendrepo-wpmj.onrender.com//tasks/${editingTask}`, {
        method: "PUT",
        credentials: "include",
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(`https://backendrepo-wpmj.onrender.com//tasks/${deletingTask}`, {
        method: "DELETE",
        credentials: "include",
      });
