...
export function TaskProvider({ children }) {
  ...
  const fetchTasks = useCallback(async () => {
    try {
      const data = await api("https://backendrepo-wpmj.onrender.com/tasks");
  ...
  const fetchUsers = useCallback(async () => {
    try {
      const data = await api("https://backendrepo-wpmj.onrender.com/users");
  ...
  const fetchCurrentUser = useCallback(async () => {
    try {
      const data = await api("https://backendrepo-wpmj.onrender.com/auth/profile");
      setCurrentUser(data);
    } catch (e) {
      console.error(e);
    }
  ...
  const createTask = useCallback(
    async (payload) => {
      const newTask = await api("https://backendrepo-wpmj.onrender.com/tasks", {
        method: "POST",
  ...
  const updateTask = useCallback(
    async (id, payload) => {
      const updated = await api(`https://backendrepo-wpmj.onrender.com/tasks/${id}`, {
        method: "PUT",
        body: JSON.stringify(payload),
      });
  ...
  const deleteTask = useCallback(
    async (id) => {
      await api(`https://backendrepo-wpmj.onrender.com/tasks/${id}`, { method: "DELETE" });
